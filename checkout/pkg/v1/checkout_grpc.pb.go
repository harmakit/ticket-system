...
type CheckoutServiceClient interface {
	...
	PlaceOrder(ctx context.Context, in *PlaceOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *checkoutServiceClient) PlaceOrder(ctx context.Context, in *PlaceOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type CheckoutServiceServer interface {
	...
	PlaceOrder(context.Context, *PlaceOrderRequest) (*emptypb.Empty, error)
...
func (UnimplementedCheckoutServiceServer) PlaceOrder(context.Context, *PlaceOrderRequest) (*emptypb.Empty, error) {
